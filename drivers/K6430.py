...
from KeithleyCustom import Keithley_6430
qc.Instrument.close_all()
smu = Keithley_6430("SMU", "ASRL3::INSTR",terminator="\r")
...
smu.source_voltage_range(20)
smu.source_current_compliance(1e-3)
smu.output_enabled(True)
v, i, r = [], [], []
for volt in np.linspace(-10, 10, 10): # set voltage, measure all 3
...
class Keithley_6430(VisaInstrument):
    ...
    def __init__(self, name: str,
        ...
        self.visa_handle.timeout = 10000  # Timeout in ms
